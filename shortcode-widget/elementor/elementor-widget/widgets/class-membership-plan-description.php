 ...
 * @since 1.0.0
 */
class MEMBERSHIP_PLAN_DESCRIPTION extends Widget_Base {
	...
	public function get_name() {
		return 'upsell-additional-offer-five';
	}
	...
	public function get_title() {
		return esc_html__( 'Membership Plan Description', 'membership-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Membership Plan Description', 'membership-for-woocommerce' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => array(
					'active' => true,
				),
				'placeholder' => '[wps_membership_desc_data plan_id=]',
				'default'     => '[wps_membership_desc_data plan_id=]',
			)
		);
	...
	protected function render() {
		...
		?>
		<div class="elementor-shortcode"><?php echo wp_kses_post( $shortcode ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
		<?php
	}
