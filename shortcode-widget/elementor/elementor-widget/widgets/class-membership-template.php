 ...
 * @since 1.0.0
 */
class MEMBERSHIP_TEMPLATE extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Membership Template', 'membership-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Membership Template', 'membership-for-woocommerce' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => array(
					'active' => true,
				),
				'placeholder' => '[wps_membership_plan_template plan_id1= plan_id2=]',
				'default'     => '[wps_membership_plan_template plan_id1= plan_id2=]',
			)
		);
