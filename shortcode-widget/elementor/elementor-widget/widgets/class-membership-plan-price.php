 ...
 * @since 1.0.0
 */
class MEMBERSHIP_PLAN_PRICE extends Widget_Base {
	...
	public function get_name() {
		return 'upsell-additional-offer-four';
	}
	...
	public function get_title() {
		return esc_html__( 'Membership Plan Price', 'membership-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => '[wps_membership_price plan_id=]',
				'default'     => '[wps_membership_price plan_id=]',
			)
		);
