 ...
 * @since 1.0.0
 */
class MEMBERSHIP_PLAN_TITLE extends Widget_Base {
	...
	public function get_name() {
		return 'upsell-additional-offer-three';
	}
	...
	public function get_title() {
		return esc_html__( 'Membership Plan Title', 'membership-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => '[wps_membership_title_name plan_id=]',
				'default'     => '[wps_membership_title_name plan_id=]',
			)
		);
