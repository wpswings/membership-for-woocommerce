 ...
 * @since 1.0.0
 */
class MEMBERSHIP_THANKS_BUTTON extends Widget_Base {
	...
	public function get_name() {
		return 'upsell-additional-offer-two';
	}
	...
	public function get_title() {
		return esc_html__( 'Membership Thanks Button', 'membership-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Membership Thanks Button', 'membership-for-woocommerce' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => array(
					'active' => true,
				),
				'placeholder' => '[wps_membership_no]',
				'default'     => '[wps_membership_no]',
			)
		);
