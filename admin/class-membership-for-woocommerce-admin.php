...
class Membership_For_Woocommerce_Admin {
	...
	public function mfw_admin_enqueue_scripts( $hook ) {
		...
		if ( isset( $screen->id ) && 'wp-swings_page_home' === $screen->id || 'wp-swings_page_membership_for_woocommerce_menu' === $screen->id ) {
			...
			wp_register_script( $this->plugin_name . 'admin-js', MEMBERSHIP_FOR_WOOCOMMERCE_DIR_URL . 'admin/js/membership-for-woocommerce-admin.js', array( 'jquery', 'wps-mfw-select2', 'wps-mfw-metarial-js', 'wps-mfw-metarial-js2', 'wps-mfw-metarial-lite' ), $this->version, false );
			wp_localize_script(
	...
	public function mfw_admin_general_settings_page( $mfw_settings_general ) {
		...
		$wps_membership_global_settings = get_option( 'wps_membership_global_options', $instance->default_global_options() );

		$wps_membership_global_settings['wps_membership_enable_plugin'] = get_option( 'wps_membership_enable_plugin' );
		$wps_membership_global_settings['wps_membership_delete_data'] = get_option( 'wps_membership_delete_data' );
		$wps_membership_global_settings['wps_membership_plan_user_history'] = get_option( 'wps_membership_plan_user_history' );
		$wps_membership_global_settings['wps_membership_email_subject'] = get_option( 'wps_membership_email_subject' );
		$wps_membership_global_settings['wps_membership_email_content'] = get_option( 'wps_membership_email_content' );
		$wps_membership_global_settings['wps_membership_for_woo_delete_data'] = get_option( 'wps_membership_for_woo_delete_data' );

		$wps_membership_global_settings['wps_membership_attach_invoice'] = get_option( 'wps_membership_attach_invoice' );
		$wps_membership_global_settings['wps_membership_invoice_address'] = get_option( 'wps_membership_invoice_address' );
		$wps_membership_global_settings['wps_membership_invoice_phone'] = get_option( 'wps_membership_invoice_phone' );
		$wps_membership_global_settings['wps_membership_invoice_email'] = get_option( 'wps_membership_invoice_email' );
		$wps_membership_global_settings['wps_membership_invoice_logo'] = get_option( 'wps_membership_invoice_logo' );
