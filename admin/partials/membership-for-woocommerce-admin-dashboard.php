...
<header>
	...
	<div class="wps-header-container wps-bg-white wps-r-8">
		...
		<span>|</span>
		<a href="https://wa.me/message/JSDF7KNKMUSKA1" target="_blank" class="wps-link"><img src="<?php echo esc_url( MEMBERSHIP_FOR_WOOCOMMERCE_DIR_URL . 'admin/image/whatsapp.png' ); ?>" height="20" width="20"><?php esc_html_e( 'Connect with us', 'membership-for-woocommerce' ); ?></a>
