				...
				<td class="forminp forminp-text">
					<div class="wps_membership_shortcode_div">
						<div class="wps_membership_shortcode">
							...
							<span class="wps_membership_shortcode_content"><?php echo esc_html( '[wps_membership_buy_now plan_id=278]' ); ?></span>
							<?php
					...
					<div class="wps_membership_shortcode_div">
						<div class="wps_membership_shortcode">
							...
							<span class="wps_membership_shortcode_content"><?php echo esc_html( '[wps_membership_no]' ); ?></span>
							<?php
				...
				<td class="forminp forminp-text">
					<div class="wps_membership_shortcode_div">
						<div class="wps_membership_shortcode">
							...
							<span class="wps_membership_shortcode_content"><?php echo esc_html( '[wps_membership_title_name plan_id=278]' ); ?></span>
							<?php
					...
					<div class="wps_membership_shortcode_div">
						<div class="wps_membership_shortcode">
							...
							<span class="wps_membership_shortcode_content"><?php echo esc_html( '[wps_membership_price plan_id=278]' ); ?></span>
							<?php
					...
					<div class="wps_membership_shortcode_div">
						<div class="wps_membership_shortcode">
							...
							<span class="wps_membership_shortcode_content"><?php echo esc_html( '[wps_membership_desc_data plan_id=278]' ); ?></span>
							<?php
				...
				<td class="forminp forminp-text">
					<div class="wps_membership_shortcode_div">
						<div class="wps_membership_shortcode">
							...
							<span class="wps_membership_shortcode_content"><?php echo esc_html( '[wps_membership_registration_form]' ); ?></span>
							<?php
