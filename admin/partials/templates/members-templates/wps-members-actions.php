...
<ul class="member_status submitbox">
	<li class="wide" id="status">
		...
		<select name="member_status" id="member_status">
			<option <?php selected( $mem_status, 'pending' ); ?> value="pending"><?php esc_html_e( 'Pending', 'membership-for-woocommerce' ); ?></option>
			<option <?php selected( $mem_status, 'hold' ); ?> value="hold"><?php esc_html_e( 'On-hold', 'membership-for-woocommerce' ); ?></option>
			<option <?php selected( $mem_status, 'complete' ); ?> value="complete"><?php esc_html_e( 'Completed', 'membership-for-woocommerce' ); ?></option>
			<option <?php selected( $mem_status, 'cancelled' ); ?> value="cancelled"><?php esc_html_e( 'Cancelled', 'membership-for-woocommerce' ); ?></option>
		</select>
