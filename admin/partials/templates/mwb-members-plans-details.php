...
$plan = get_post_meta( $post->ID, 'plan_obj' );
	...
	<div class="mwb_members_plans">
		<table class="form-table">
			<tr>
				...
				<td>
					<?php echo esc_html( $plan[0]['post_title'] ); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo sprintf( ' %s %s ', esc_html( get_woocommerce_currency() ), esc_html( $plan[0]['mwb_membership_plan_price'][0] ) ); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo esc_html( $plan[0]['post_content'] ); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo esc_html( $plan[0]['mwb_membership_plan_name_access_type'][0] ); ?>
				</td>
			</tr>

			<?php
			switch ( $plan[0]['mwb_membership_plan_name_access_type'][0] ) {
				...
				case 'limited':
					echo '<tr>
							...
							<td>' . sprintf( ' %u %s ', esc_html( $plan[0]['mwb_membership_plan_duration'][0] ), esc_html( $plan[0]['mwb_membership_plan_duration_type'][0] ) ) . '</td>
						</tr>';
					break;
				...
				case 'date_ranged':
					echo '<tr>
							...
							<td>' . sprintf( ' %u to %s ', esc_html( $plan[0]['mwb_membership_plan_start'][0] ), esc_html( $plan[0]['mwb_membership_plan_end'][0] ) ) . '</td>
						</tr>';
					break;
			...
			<tr>
				...
				<td>
					<?php echo esc_html( $plan[0]['mwb_membership_plan_user_access'][0] ); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo esc_html( $plan[0]['mwb_membership_plan_access_type'][0] ); ?>
				</td>
			</tr>

			<?php
			switch ( $plan[0]['mwb_membership_plan_access_type'][0] ) {
				...
				case 'delay_type':
					echo '<tr>
							...
							<td>' . sprintf( ' %u %s ', esc_html( $plan[0]['mwb_membership_plan_time_duration'][0] ), esc_html( $plan[0]['mwb_membership_plan_time_duration_type'][0] ) ) . '</td>
						</tr>';
					break;
			...
			<tr>
				...
				<td>
					<?php echo sprintf( ' %u %s ', esc_html( $plan[0]['mwb_memebership_plan_discount_price'][0] ), esc_html( $plan[0]['mwb_membership_plan_offer_price_type'][0] ) ); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo esc_html( $plan[0]['mwb_memebership_plan_free_shipping'][0] ); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php
					$prod_ids = maybe_unserialize( $plan[0]['mwb_membership_plan_target_ids'][0] );
			...
			<tr>
				...
				<td>
					<?php
					$cat_ids = maybe_unserialize( $plan[0]['mwb_membership_plan_target_categories'][0] );
