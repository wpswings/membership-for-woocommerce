<div class="mwb-overview__wrapper">
	...
	<div class="mwb-overview__content">
		<div class="mwb-overview__content-description">
			...
			<h3><?php esc_html_e( 'As a store owner, you get to:', 'membership-for-woocommerce' ); ?></h3>
			<ul class="mwb-overview__features">
				<li><?php esc_html_e( 'Lorem Ipsum is simply dummy text.', 'membership-for-woocommerce' ); ?></li>
				<li><?php esc_html_e( 'Lorem Ipsum is simply dummy text.', 'membership-for-woocommerce' ); ?></li>
			</ul>
		</div>
