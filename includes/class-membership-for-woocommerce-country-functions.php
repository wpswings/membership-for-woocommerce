<?php
/**
 * The country functionality of the plugin.
 *
...
/**
 * The Country functions class of the plugin.
 *
 * @package    Membership_For_Woocommerce
 * @subpackage Membership_For_Woocommerce/admin
 * @author     Make Web Better <plugins@makewebbetter.com>
 */
class Membership_For_Woocommerce_Country_Functions {
	...
	public function get_country_list() {
		...
		return apply_filters( 'mwb_membership_countries', $countries );
	}
	 ...
	 * @since 1.0.0
	 */
	public function get_us_states_list() {
		...
		return apply_filters( 'mwb_membership_us_states', $states );
	}

	/**
	 * Return an array of Angola provinces.
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_angola_provinces_list() {
		...
		$provinces = array(
			...
			return apply_filters( 'mwb_membership_angola_provinces', $provinces );
	}

	/**
	 * Return an array of Canada provinces.
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_canada_provinces_list() {
		...
		return apply_filters( 'mwb_membership_canada_provinces', $provinces );
	}

	/**
	 * Return an array of Australian States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_australia_states_list() {
		...
		return apply_filters( 'mwb_membership_australia_states', $states );
	}

	/**
	 * Return an array of Bangladeshi States (districts)
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_bangladesh_states_list() {
		...
		return apply_filters( 'mwb_membership_bangladesh_states', $states );
	}

	/**
	 * Return an array of Brazil States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_brazil_states_list() {
		...
		return apply_filters( 'mwb_membership_brazil_states', $states );
	}

	/**
	 * Return an array of Bulgarian States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_bulgaria_states_list() {
		...
		return apply_filters( 'mwb_membership_bulgaria_states', $states );
	}

	/**
	 * Return an array of Hong Kong States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_hong_kong_states_list() {
		...
		return apply_filters( 'mwb_membership_hong_kong_states', $states );
	}

	/**
	 * Return an array of Hungary States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_hungary_states_list() {
		...
		return apply_filters( 'mwb_membership_hungary_states', $states );
	}

	/**
	 * Return an array of Japanese States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_japan_states_list() {
		...
		return apply_filters( 'mwb_membership_japan_states', $states );
	}

	/**
	 * Return an array of China States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_china_states_list() {
		...
		return apply_filters( 'mwb_membership_china_states', $states );
	}

	/**
	 * Return an array of United Kingdom States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_uk_states_list() {
		...
		return apply_filters( 'mwb_membership_uk_states', $states );
	}

	/**
	 * Return an array of New Zealand States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_new_zealand_states_list() {
		...
		return apply_filters( 'mwb_membership_new_zealand_states', $states );
	}

	/**
	 * Return an array of Peru States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_peru_states_list() {
		...
		return apply_filters( 'mwb_membership_peru_states', $states );
	}

	/**
	 * Return an array of Indonesia States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_indonesia_states_list() {
		...
		return apply_filters( 'mwb_membership_indonesia_states', $states );
	}

	/**
	 * Return an array of India States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_india_states_list() {
		...
		return apply_filters( 'mwb_membership_india_states', $states );
	}

	/**
	 * Return an array of Iran States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_iran_states_list() {
		...
		return apply_filters( 'mwb_membership_iran_states', $states );
	}

	/**
	 * Return an array of Italy Provinces
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_italy_states_list() {
		...
		return apply_filters( 'mwb_membership_italy_states', $states );
	}

	/**
	 * Return an array of Malaysia States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_malaysia_states_list() {
		...
		return apply_filters( 'mwb_membership_malaysia_states', $states );
	}

	/**
	 * Return an array of Mexican States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_mexico_states_list() {
		...
		return apply_filters( 'mwb_membership_mexico_states', $states );
	}

	/**
	 * Return an array of Nepal States (Districts)
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_nepal_states_list() {
		...
		return apply_filters( 'mwb_membership_nepal_states', $states );
	}

	/**
	 * Return an array of South African States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_south_africa_states_list() {
		...
		return apply_filters( 'mwb_membership_south_africa_states', $states );
	}

	/**
	 * Return an array of Thailand States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_thailand_states_list() {
		...
		return apply_filters( 'mwb_membership_thailand_states', $states );
	}

	/**
	 * Return an array of Turkey States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_turkey_states_list() {
		...
		return apply_filters( 'mwb_membership_turkey_states', $states );
	}

	/**
	 * Return an array of Spain States
	 *
	 * @return array
	 * @since 1.0.0
	 */
	public function get_spain_states_list() {
		...
		return apply_filters( 'mwb_membership_spain_states', $states );
	}

	/**
	 * Returns an array of selected states.
	 *
	...
	public function get_country_states( $country ) {
		...
		switch ( $country ) {
			...
			case 'US':
				$states = $this->get_us_states_list();
				break;

			case 'AO':
				$states = $this->get_angola_provinces_list();
				break;

			case 'CA':
				$states = $this->get_canada_provinces_list();
				break;

			case 'AU':
				$states = $this->get_australia_states_list();
				break;

			case 'BD':
				$states = $this->get_bangladesh_states_list();
				break;

			case 'BG':
				$states = $this->get_bulgaria_states_list();
				break;
			...
			case 'CN':
				$states = $this->get_china_states_list();
				break;

			case 'GB':
				$states = $this->get_uk_states_list();
				break;
			...
			case 'ID':
				$states = $this->get_indonesia_states_list();
				break;

			case 'IN':
				$states = $this->get_india_states_list();
				break;

			case 'IR':
				$states = $this->get_iran_states_list();
				break;

			case 'IT':
				$states = $this->get_italy_states_list();
				break;

			case 'JP':
				$states = $this->get_japan_states_list();
				break;

			case 'MX':
				$states = $this->get_mexico_states_list();
				break;

			case 'MY':
				$states = $this->get_malaysia_states_list();
				break;

			case 'NP':
				$states = $this->get_nepal_states_list();
				break;
			...
			case 'PE':
				$states = $this->get_peru_states_list();
				break;
			...
			case 'ZA':
				$states = $this->get_south_africa_states_list();
				break;
		...
		return apply_filters( 'mwb_membership_states', $states, $country );
	}
