...
class Makewebbetter_Onboarding_Helper {
	...
	public function enqueue_styles() {
		...
		if ( $this->is_valid_page_screen() ) {
			...
			wp_enqueue_style( 'makewebbetter-onboarding-style', MEMBERSHIP_FOR_WOOCOMMERCE_URL . 'admin/css/makewebbetter-onboarding-admin.css', array(), '1.0.0', 'all' );

			// Uncomment Only when your plugin doesn't uses the Select2
			wp_enqueue_style( 'makewebbetter-onboarding-select2-style', MEMBERSHIP_FOR_WOOCOMMERCE_URL . 'admin/css/select2.min.css', array(), '1.0.0', 'all' );
		}
	}
	...
	public function enqueue_scripts() {
		...
		if ( $this->is_valid_page_screen() ) {
			...
			wp_enqueue_script( 'makewebbetter-onboarding-scripts', MEMBERSHIP_FOR_WOOCOMMERCE_URL . 'admin/js/makewebbetter-onboarding-admin.js', array( 'jquery' ), '1.0.0', true );
			...
			// Uncomment Only when your plugin doesn't uses the Select2
			wp_enqueue_script( 'makewebbetter-onboarding-select2-script', MEMBERSHIP_FOR_WOOCOMMERCE_URL . 'admin/js/select2.min.js', array( 'jquery' ), '1.0.0', false );
		}
	}
	...
	public function add_onboarding_popup_screen() {
		...
		if ( $this->is_valid_page_screen() && $this->can_show_onboarding_popup() ) {
			require_once MEMBERSHIP_FOR_WOOCOMMERCE_DIRPATH . 'extra-templates/makewebbetter-onboarding-template-display.php';
		}
	}
	...
	public function add_deactivation_popup_screen() {
		...
		if ( ! empty( $pagenow ) && 'plugins.php' == $pagenow ) {
			require_once MEMBERSHIP_FOR_WOOCOMMERCE_DIRPATH . 'extra-templates/makewebbetter-deactivation-template-display.php';
		}
	}
