 ...
 * @since 1.0.0
 */
function get_angola_provinces_list() {
 ...
 * @since 1.0.0
 */
function get_canada_provinces_list() {
 ...
 * @since 1.0.0
 */
function get_australia_states_list() {
 ...
 * @since 1.0.0
 */
function get_bangladesh_states_list() {
 ...
 * @since 1.0.0
 */
function get_bulgaria_states_list() {
 ...
 * @since 1.0.0
 */
function get_japan_states_list() {
 ...
 * @since 1.0.0
 */
function get_china_states_list() {
 ...
 * @since 1.0.0
 */
function get_indonesia_states_list() {
 ...
 * @since 1.0.0
 */
function get_india_states_list() {
 ...
 * @since 1.0.0
 */
function get_italy_states_list() {
 ...
 * @since 1.0.0
 */
function get_malaysia_states_list() {
 ...
 * @since 1.0.0
 */
function get_mexico_states_list() {
 ...
 * @since 1.0.0
 */
function get_nepal_states_list() {
 ...
 * @since 1.0.0
 */
function get_south_africa_states_list() {
...
function get_country_states( $country ) {
	...
	switch ( $country ) {
		...
		case 'AO':
			$states = get_angola_provinces_list();
			break;

		case 'CA':
			$states = get_canada_provinces_list();
			break;

		case 'AU':
			$states = get_australia_states_list();
			break;

		case 'BD':
			$states = get_bangladesh_states_list();
			break;

		case 'BG':
			$states = get_bulgaria_states_list();
			break;
		...
		case 'CN':
			$states = get_china_states_list();
			break;

		case 'GB':
			$states = get_uk_states_list();
			break;
		...
		case 'ID':
			$states = get_indonesia_states_list();
			break;

		case 'IN':
			$states = get_india_states_list();
			break;

		case 'IR':
			$states = get_iran_states_list();
			break;

		case 'IT':
			$states = get_italy_states_list();
			break;

		case 'JP':
			$states = get_japan_states_list();
			break;

		case 'MX':
			$states = get_mexico_states_list();
			break;

		case 'MY':
			$states = get_malaysia_states_list();
			break;

		case 'NP':
			$states = get_nepal_states_list();
			break;
		...
		case 'TR':
			$states = get_turkey_states_list();
			break;

		case 'ZA':
			$states = get_south_africa_states_list();
			break;

		case 'ES':
			$states = get_spain_states_list();
			break;
