				...
				<div class="membership_billing_fields_wrapper">
					...
					<p class="form-row validate-required" id="mwb_billing_first_name_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text" name="membership_billing_first_name" id="membership_billing_first_name" value="<?php echo esc_html( $first_name ); ?>" placeholder="<?php esc_html_e( 'First name&hellip;', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					<p class="form-row validate-required" id="mwb_billing_last_name_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text" name="membership_billing_last_name" id="membership_billing_last_name" value="<?php echo esc_html( $last_name ); ?>" placeholder="<?php esc_html_e( 'Last name&hellip;', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					...
					<p class="form-row validate-required" id="mwb_billing_address_1_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text" name="membership_billing_address_1" id="membership_billing_address_1" value="<?php echo esc_html( $address_1 ); ?>" placeholder="<?php esc_html_e( 'House number and street name', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					...
					<p class="form-row validate-required" id="mwb_billing_city_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text" name="membership_billing_city" id="membership_billing_city" value="<?php echo esc_html( $city ); ?>" placeholder="<?php esc_html_e( 'Town/City', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					...
					<p class="form-row validate-required" id="mwb_billing_postcode_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text" name="membership_billing_postcode" id="membership_billing_postcode" value="<?php echo esc_html( $post_code ); ?>" placeholder="<?php esc_html_e( 'Pin code', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					<p class="form-row validate-required" id="mwb_billing_phone_field">
						...
						<span class="membership-input-wrapper">
							<input type="tel" class="input-text" name="membership_billing_phone" id="membership_billing_phone" value="<?php echo esc_html( $phone ); ?>" placeholder="<?php esc_html_e( 'Phone no.', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					<p class="form-row validate-required" id="mwb_billing_email_field">
						...
						<span class="membership-input-wrapper">
							<input type="email" class="input-text" name="membership_billing_email" id="membership_billing_email" value="<?php echo esc_html( $email ); ?>" placeholder="<?php esc_html_e( 'Email', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
