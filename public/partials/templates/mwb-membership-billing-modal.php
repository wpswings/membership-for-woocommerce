...
<div class="mwb_mfw_progress-bar-wrapper">
	<ul class="mwb_mfw_progress-bar">
		<li class="mwb_mfw_progress-bar-step" id="mwb_mfw_progress-bar-a">
			<i class="fas fa-check-circle mwb_mfw_progress-bar_done"></i>
		</li>
		<li class="mwb_mfw_progress-bar-step" id="mwb_mfw_progress-bar-b">
...
<div class="mwb_mfw_multi-level-form">
	<div class="mwb_mfw_billing-heading">
	...
	<div class="membership_customer_details" id="membership_customer_details" >
		...
		<div class="membership_billing_fields" >
			...
			<div class="membership_billing_fields_wrapper">
				...
				<!-- personal details -->
				<div class="mwb_mfw_form-field-wrapper-part-a">

					<input type="hidden" name="plan_id" id="membership_plan_id" value="<?php echo esc_html( $plan_id ); ?>" >
					<div class="mwb_mfw_complete-name">
						<p class="form-row validate-required mwb_mfw_form_field-wrapper" id="mwb_billing_first_name_field">
							...
							<span class="membership-input-wrapper">
								<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_first_name" id="membership_billing_first_name" value="<?php echo esc_html( $first_name ); ?>" placeholder="<?php esc_html_e( 'First name&hellip;', 'membership-for-woocommerce' ); ?>" required>
							</span>
						</p>
						<p class="form-row validate-required mwb_mfw_form_field-wrapper" id="mwb_billing_last_name_field">
							...
							<span class="membership-input-wrapper">
								<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_last_name" id="membership_billing_last_name" value="<?php echo esc_html( $last_name ); ?>" placeholder="<?php esc_html_e( 'Last name&hellip;', 'membership-for-woocommerce' ); ?>" required>
							</span>
						</p>
					</div>
					<p class="form-row mwb_mfw_form_field-wrapper" id="mwb_billing_company_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_company" id="membership_billing_company" value="<?php echo esc_html( $company ); ?>" placeholder="<?php esc_html_e( 'Company name', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					<p class="form-row validate-required mwb_mfw_form_field-wrapper" id="mwb_billing_phone_field">
				...
				<div class="mwb_mfw_form-field-wrapper-part-b">
					<p class="form-row validate-required mwb_mfw_form_field-wrapper" id="mwb_billing_address_1_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_address_1" id="membership_billing_address_1" value="<?php echo esc_html( $address_1 ); ?>" placeholder="<?php esc_html_e( 'House number and street name', 'membership-for-woocommerce' ); ?>" required>
						</span>
					</p>
					<p class="form-row mwb_mfw_form_field-wrapper" id="mwb_billing_address_2_field">	
						<span class="membership-input-wrapper">
							<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_address_2" id="membership_billing_address_2" value="<?php echo esc_html( $address_2 ); ?>" placeholder="<?php esc_html_e( 'Apartment, suit, unit, etc. (Optional)', 'membership-for-woocommerce' ); ?>">
						</span>
					</p>
					<p class="form-row validate-required mwb_mfw_form_field-wrapper" id="mwb_billing_city_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_city" id="membership_billing_city" value="<?php echo esc_html( $city ); ?>" placeholder="<?php esc_html_e( 'Town/City', 'membership-for-woocommerce' ); ?>" required>
						</span>
					</p>
					<p class="form-row mwb_mfw_form_field-wrapper" id="mwb_billing_country_field">
						...
						<span class="membership-input-wrapper">
							<select name="membership_billing_country" id="membership_billing_country" class="wc-enhanced-select mwb_country_select mwb_mfw_form_field" required>
					...
					<p class="form-row validate-required mwb_mfw_form_field-wrapper" id="mwb_billing_postcode_field">
						...
						<span class="membership-input-wrapper">
							<input type="text" class="input-text mwb_mfw_form_field" name="membership_billing_postcode" id="membership_billing_postcode" value="<?php echo esc_html( $post_code ); ?>" placeholder="<?php esc_html_e( 'Pin code', 'membership-for-woocommerce' ); ?>" required>
						</span>
					</p>
				</div>
			</div>
	...
	<div class="mwb_mfw_pre-next-btn">
		<div class="mwb_mfw_previous">
			<button type="button" class="mwb_mfw_btn-back-a mwb_mfw_button-main"><?php esc_html_e( 'Previous Step', 'membership-for-woocommerce' ); ?></button>
			<button type="button" class="mwb_mfw_btn-back-b mwb_mfw_button-main"><?php esc_html_e( 'Previous Step', 'membership-for-woocommerce' ); ?></button>
		</div>
		<div class="mwb_mfw_next">
			<button type="button" class="mwb_mfw_btn-next-a mwb_mfw_button-main"><?php esc_html_e( 'Next Step', 'membership-for-woocommerce' ); ?></button>
			<button type="button" class="mwb_mfw_btn-next-b mwb_mfw_button-main"><?php esc_html_e( 'Next Step', 'membership-for-woocommerce' ); ?></button>
	...
	<div class="mwb_mfw_order-confirm"><span><?php esc_html_e( 'Your order is confirmed.', 'membership-for-woocommerce' ); ?></span>
		<button type="button" class="mwb_mfw_purchase-again mwb_mfw_button-main"><?php esc_html_e( 'Shop more', 'membership-for-woocommerce' ); ?></button>
	</div>
</div>
